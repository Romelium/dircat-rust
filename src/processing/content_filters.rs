...
///     let value = 10;"#;
///
/// assert_eq!(filter.apply(code).trim(), expected);
/// ```
fn remove_comments_logic(content: &str) -> String {
    enum State {
        Normal,
        MaybeSlash,           // Seen '/'
        LineComment,          // Seen '//'
...
impl ContentFilter for RemoveEmptyLinesFilter {
    fn apply(&self, content: &str) -> String {
        remove_empty_lines_logic(content)
    }
    fn name(&self) -> &'static str {
...
///
/// assert_eq!(filter.apply(text), expected);
/// ```
fn remove_empty_lines_logic(content: &str) -> String {
    content
        .lines()
...
mod tests {
    ...
    fn test_remove_empty() {
        let input = "Line 1\n\n  \nLine 4\n";
        let expected = "Line 1\nLine 4";
        assert_eq!(remove_empty_lines_logic(input), expected);
    }
    ...
    fn test_remove_line_comment_simple() {
        ...
        assert_eq!(remove_comments_logic(input), expected);
    }
    ...
    fn test_comment_markers_in_chars() {
        ...
        assert_eq!(remove_comments_logic(input2), expected2);
    }
